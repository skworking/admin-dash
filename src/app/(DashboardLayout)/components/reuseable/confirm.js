...
const CustomConfirmation = ({ message, onConfirm, onCancel }) => {
  return (
    ...
    <div className='sm:flex justify-center gap-10 '>
      <Button onClick={onCancel} text="Cancel" styles="sm:w-1/6 bg-red-400 p-5 hover:bg-red-600 "></Button>
      <Button onClick={onConfirm} text="Confirm" styles="sm:w-1/6 bg-green-500 hover:bg-green-600"></Button>
    </div>  
    </div>
  );
};
