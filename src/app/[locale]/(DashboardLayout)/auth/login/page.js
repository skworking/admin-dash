...
const SignIn = () => {
  ...
  return (
    <div className="flex justify-center item-center flex-col w-full h-full absolute sm:p-20 p-2 m-auto ">
            ...
            <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
              <div className="w-full  p-4 sm:p-12.5 xl:p-17.5">
                ...
                <Form form={form} onFinish={handleSignIn}>
                  ...
                  >
                    <Input prefix={<MailOutlined />} placeholder="Email" value={email}
